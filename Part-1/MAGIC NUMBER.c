// Program to check whether the number is a MAGIC NUMBER in C
#include <stdio.h>
#include <conio.h>
 int main ()
{
 ...
 sum_of_digits = sum_of_digits + temp % 10; /* use modulus symbol to get the remainder of each iteration by
temp % 10 */
...
// get the reverse sum of given digits
 ...
 The reverse of the digits = 9
 The product of 9 * 9 = 81
 45 is not a Magic Number. */
